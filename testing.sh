...
echo "Testing 1000 mixed containers "

echo "Cleaning up the database..."
# Clean-up database and remove all containers
python main.py --remove all

echo "Execution Times for 1000 mixed containers" >> $LOG_FILE
echo "" >> $LOG_FILE

echo "Computing Loading and Analyzing times for 1000 containers..."
